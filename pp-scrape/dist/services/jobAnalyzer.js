...
exports.jobAnalyzer = exports.JobAnalyzer = void 0;
const jobAnalyzerModels_1 = require("./jobAnalyzerModels");
...
class JobAnalyzer {
    ...
    async initializeWithResume(resumePath) {
        this.resumeContext = await textExtractor_1.textExtractor.getResumeText(resumePath);
    }
    async analyzeJobPage(page) {
    ...
    async analyzeJobMatch(jobDetails) {
        ...
        logger_1.default.debug(SERVICE_NAME, "Analyzing job match content sizes", {
...
Red Flags & Differentiators:
  ...
  20. Potential culture fit signals`
        ...
        try {
            ...
            try {
                await database_1.dbService.saveJobAnalysis({
                    url: jobDetails.url,
    ...
    async quickJobScreening(jobTitle) {
        if (!this.resumeContext) {
            throw new Error("Resume context not initialized. Call initializeWithResume first.");
        }
        const response = await this.openai.chat.completions.create({
...
exports.jobAnalyzer = new JobAnalyzer();
